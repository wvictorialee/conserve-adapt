...
Although brush-piles are less air-tight than the rubber seals typically seen on modern windows, they are more customisable to fit historic windows which may not have uniform gaps all around. Further, as explained in [Basic Principles]({{<relref "docs/principles/_index.md">}}), historic and traditional buildings are not designed to be airtight. For instance, some air movement is meant to pass through even a good condition sash and case window.
...
### Double-Glazing
Double-glazing is called ‘Insulated Glass Units’ or IGUs in the technical parlance. This means two panes of glass separated by a gap filled with air or inert gas. This construction can reduce the heat loss through the glass panes themselves (see [Common Window Issues]({{< relref "docs/issues/_index.md#draughts" >}})). The depth of the gap between the two glass panes, the type of gas that fills this gap (or if the gap is a vacuum cavity), and indeed the thickness and type of glass panes themselves, can all influence how much heat goes through the glass. 
...
<figure class="my-6 mx-auto text-center w-3/4 md:w-1/2">
    <img
    src="blown.webp"
    alt="Example of blown panes on slim-profile double glazing."
...
<figure class="my-6 mx-auto text-center w-3/4 md:w-1/2">
    <img
    src="vacuum.webp"
    alt="Example of vacuum double glazing with spacers that appear as dots."
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
    />
...
<figure class="my-6 mx-auto text-center w-3/4 md:w-1/2">
    <img
    src="secondary.webp"
    alt="A corner sample of secondary glazing with metal frame."
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
    />
...
<figure class="my-6 mx-auto text-center">
    <img
    src="plastic.webp"
    alt="Examples of secondary glazing system with large plastic sheets."
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
    />
...
<figure class="my-6 mx-auto text-center">
    <img
    src="portrait.webp"
    alt="Secondary glazing system at the National Galleries Scotland: Portrait."
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
    />
...
<figure class="my-6 mx-auto text-center w-3/4 md:w-1/2">
    <img
    src="gecko.webp"
    alt="An example of how the plastic panel looks when installed (right pane)."
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
    />
