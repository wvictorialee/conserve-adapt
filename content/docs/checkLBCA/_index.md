...
<figure class="my-6 mx-auto text-center">
  <img
    src="map_layers.webp"
    alt="Screenshot of the Historic Environment Scotland Destination Map Search showing layers"
...
<figure class="my-6 mx-auto text-center">
  <img
    src="map_LBinfo.webp"
    alt="Screenshot of the Historic Environment Scotland Destination Map Search showing listed building info"
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
  />
...
<figure class="my-6 mx-auto text-center">
  <img
    src="map_base.webp"
    alt="Screenshot of the Historic Environment Scotland Destination Map with Conservation Areas"
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
  />
...
<figure class="my-6 mx-auto text-center">
  <img
    src="map_CAinfo.webp"
    alt="Screenshot of the Historic Environment Scotland Destination Map with Conservation Area Info"
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
  />
...
<figure class="my-6 mx-auto text-center">
  <img
    src="map_legend.webp"
    alt="Screenshot of the Historic Environment Scotland Destination Map with Listed Buildings, Conservation Areas, and World Heritage Sites layers turned on"
    class="w-full rounded-lg shadow-sm"
    loading="lazy"
    decoding="async"
  />
