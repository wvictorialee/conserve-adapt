...
<figure class="my-6 mx-auto text-center w-9/12 md:w-3/5 lg:w-2/3">
  <a href="https://citydev-portal.edinburgh.gov.uk/idoxpa-web/search.do?action=advanced" target="_blank" rel="noopener" aria-label="Open the Planning Portal in a new tab">
    <img
      src="planningportal.webp"
      alt="Screenshot of Edinburgh Planning Portal Advanced Search"
...
<figure class="my-6 mx-auto text-center">
  <a href="https://www.trove.scot/search?page_type=All&viewmode=grid" target="_blank" rel="noopener" aria-label="Open trove.scot in a new tab">
    <img
      src="trove.webp"
      alt="Screenshot of trove.scot showing search results of 'Edinburgh Heriot Row'"
      class="mx-auto w-full rounded-lg shadow-md hover:shadow-md transition-shadow"
      loading="lazy"
      decoding="async"
    />
